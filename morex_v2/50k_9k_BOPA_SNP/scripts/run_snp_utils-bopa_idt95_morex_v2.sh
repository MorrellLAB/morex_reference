...
REF_FASTA="/panfs/roc/groups/9/morrellp/shared/References/Reference_Sequences/Barley/Morex_v2/Barley_Morex_V2_pseudomolecules.fasta"
...
OUT_DIR="/panfs/roc/groups/9/morrellp/shared/References/Reference_Sequences/Barley/Morex_v2/bopa_9k_50k"
DISTANCE_THRESHOLD="100000"
# The SNP_ARRAY variable will only be used for file naming
SNP_ARRAY="bopa"
PERCENT_IDENTITY="95"
OUT_PREFIX="${SNP_ARRAY}_morex_v2_idt${PERCENT_IDENTITY}"
# These are set for Morex v2
